...
def InferenceAnalysis(strMessage, bVerbose, Extensions):
    ...
    print GetTime() + " " + "Checking historical information..."
    Log("Checking historical information...")
    lambda_to_parent_historical = historical(strMessage) # Perform the historical analysis
    
    print GetTime() + " " + "Performing whois to: " + strAddress
    Log("Performing whois to: " + strAddress)
    lambda_to_parent_whois = whois(strAddress) # Whois analysis

    print GetTime() + " " + "Getting geographic location of: " + strAddress
    Log("Getting geographic location of: " + strAddress)
    lambda_to_parent_gl = gl(strAddress) # Graphical location analysis
    
    print GetTime() + " " + "Performing reverse DNS to: " + strContact_c
    Log("Performing reverse DNS to: " + strContact_c)
    lambda_to_parent_rdns = rdns(strContact_c) # Reverse DNS analysis    
    
    print GetTime() + " " + "Checking DNS coherence..."
    Log("Checking DNS coherence...")
    lambda_to_parent_dns = dns(strMessage) # DNS analysis

    print GetTime() + " " + "Checking fingerprint..."
    ...
    print GetTime() + " " + "Checking \"To\" field coherence..."
    Log("Checking \"To\" field coherence...")
    lambda_to_parent_to = checkto(strMessage, Extensions) # "To" analysis. It returns the to_parent value, so there's no need to calculate it.
    ...
    print GetTime() + " " + "Getting dispersion of source points... (this may take some minutes)"
    Log("Getting dispersion of source points...")
    lambda_to_parent_dispersion = dispersion(strMessage) # Dispersion analysis. It returns the to_parent value, so there's no need to calculate it.
...
def whois(strAddress):
    ...
    try:
        ...
        print GetTime() + " " + "WARNING whois is not installed"
        Log("WARNING whois is not installed")
        return (1,1)
    ...
    try:
        ...
        print GetTime() + " " + "WARNING Can't read securelist.txt. The whois analysis is not completed."
        Log("WARNING Can't read securelist.txt. The whois analysis is not completed.")
        return (0.3,0.7)
    
    if verbose == True:
        print GetTime() + " " + "WHOIS IP: " + strAddress
        print GetTime() + " " + "WHOIS Data: " + strData
...
def gl(strAddress):
    ...
    if bDNS == False:
        try:        
            ...
            print GetTime() + " " + "WARNING nslookup command is not installed"
            Log("WARNING nslookup command is not installed")
            return (1,1)
    ...
    try:
        ...
        print GetTime() + " " + "WARNING Can't read /cptdb/gl.conf. The gl analysis is not completed."
        Log("WARNING Can't read /cptdb/gl.conf. The gl analysis is not completed.")
        return (1,1)

    if verbose == True:
        
        print GetTime() + " " + "GL IP: " + strAddress
        print GetTime() + " " + "GL Loc: " + strIP2C
...
def rdns(strAddress):
    ...
    try:
        ...
        if strIP.find("not found") != -1:
            if verbose == True:
                print GetTime() + " " + "RDNS IP: " + strAddress
                print GetTime() + " " + "RDNS NAME: NOT FOUND"
        ...
        print GetTime() + " " + "WARNING host command is not installed"
        Log("WARNING host command is not installed")
    ...
    try:
        ...
        print GetTime() + " " + "WARNING Can't read /cptdb/rdns.conf. The reverse dsn analysis is not completed."
        Log("WARNING Can't read /cptdb/rdns.conf. The reverse dsn analysis is not completed.")
        return (1,1)
    
    if verbose == True:
        print GetTime() + " " + "RDNS IP: " + strAddress
        print GetTime() + " " + "RDNS NAME: " + strIP
        Log("RDNS IP: " + strAddress)
        Log("RDNS NAME: " + strIP)
...
def dns(strMessage):
    ...
    if verbose == True:
        print GetTime() + " " + "DNS or IP From: " + strDNS
        print GetTime() + " " + "DNS or IP Contact: " + strIP
        Log("DNS or IP From: " + strDNS)
        Log("DNS or IP Contact: " + strIP)
    ...
    if verbose == True:
        print GetTime() + " " + "IP From: " + strDNS
        print GetTime() + " " + "IP Contact: " + strIP
        Log("IP From: " + strDNS)
        Log("IP Contact: " + strIP)
...
def fingerprint(strMessage):
    ...
    try:
        ...
        print GetTime() + " " + "WARNING Can't read /cptdb/fingerprint.conf. The fingerprint analysis is not completed."
        Log("WARNING Can't read /cptdb/fingerprint.conf. The fingerprint analysis is not completed.")
        return (1,1)
        ...
        if line.find("#") == -1 and len(line) > 2:
            if line.find("=") != -1:
                ...
                if strMessage.find(strFingerprint) != -1:
                    lambda_to_parent = (nTrusted, nDistrusted)
                    if verbose == True:
                        print GetTime() + " " + "Fingerprint found: " + strFingerprint
                        Log("Fingerprint found: " + strFingerprint)
                    break
...
def historical(strMessage):
    ...
    if os.path.isfile("./historical/database.txt") == True:
        ...
        try:
            ...
            print GetTime() + " " + "WARNING Can't read /historical/database.txt. The historical analysis is not completed."
            Log("WARNING Can't read /historical/database.txt. The historical analysis is not completed.")
            return (1,1)
    ...
    if verbose == True:
        print GetTime() + " " + "Historical number of matches: " + str(nMatches)
    ...
    if verbose == True:
        print GetTime() + " " + "Historical data: " + strDataToStore
...
def checkto(strMessage, Extensions):
    ...
    if verbose == True:
        print GetTime() + " " + "Extension in To: " + str(strMessageExtension)
        Log("Extension in To: " + str(strMessageExtension))
...
def dispersion(strMessage):
    ...
    if verbose == True:
        print GetTime() + " " + "Dispersion = " + str(nStandardDeviation)
...
def alarm(strIP, strNature):
    ...
    try:
        ...
        print GetTime() + " " + "WARNING Can't write the alarm file!"
        Log("WARNING Can't write the alarm file!")
