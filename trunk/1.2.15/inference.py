...
## InferenceAnalysis
#
# This object is created in order to analyse an INVITE message.
...
#                print self.Via[i]
    ...
    def validdns(self, strIP):
        ...
        self.add_results("| |")
        self.add_results("| | IP or domain name to analyse: " + strIP)
    ...
    def send_results(self, NoInvestigation = True):
        ...
        if NoInvestigation == True:
            ...
            strPage = strPage + "<br>Dear Administrator,<br><br>This mail was automatically generated by Artemisa in order to inform you that an INVITE message has arrived. Since Artemisa is configured not to analyse the call, just the raw SIP INVITE message is shown herein.<br><br>\n"
