...
#                print self.Via[i]
    ...
    def fingerprint(self):
        ...
        # --------------|----------------|----------------------------------
        #   Trusted     |      0.05      |      0.25      |      0.7       |
        #   Distrusted  |      0.8       |      0.15      |      0.05      |
        #
        
        if iReliability <= 0.3:
            lambda_to_parent = (0.05,0.8)
        elif iReliability > 0.3 and iReliability < 0.7:
            lambda_to_parent = (0.25,0.15)
        elif iReliability >= 0.7:
            lambda_to_parent = (0.7,0.05)     
    ...
    def historical(self, strIP):
        ...
        if os.path.isfile("./historical/database.txt") == True:
            ...
            #
            #               |  nMatches < 3  | 3 < nMatches < 6 | nMatches > 6  
            # --------------|----------------|------------------|------------------
            #   Trusted     |      0.75      |       0.2        |       0.05
            #   Distrusted  |      0.05      |       0.05       |       0.90
            #
            
            # Assigns values to lambda_to_parent according to the number of times that the IP was found in the database.
            if nMatches < 3:
                lambda_historical = (0.75,0.05)
                
            elif nMatches >= 3 and nMatches <= 6:
                lambda_historical = (0.2,0.05)
                
            elif nMatches > 6:
                lambda_historical = (0.05,0.9)
