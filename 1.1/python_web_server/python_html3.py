...
if __name__ == '__main__':
    ...
    html = dijit(page)
    #print html
    open('/home/delivery/Desktop/Workaround/Scripts/Python/web_server/python_web_server/python_html3.html', 'w+').write(html)
    #webbrowser.open('file://' + os.path.abspath('python_html3.html'))
    # TAKE INTO ACCOUNT THAT CAN'T RUN AS ROOT so:
    # python python_html3.py 
    webbrowser.open('/home/delivery/Desktop/Workaround/Scripts/Python/web_server/python_web_server/python_html3.html')
